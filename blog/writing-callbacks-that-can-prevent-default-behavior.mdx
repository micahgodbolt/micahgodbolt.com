...
title: Writing callbacks that can prevent default behavior
---
A common pattern I see in writing components is the idea of a callback: a user provided function that gets called at a particular point of a component's lifecycle. 
